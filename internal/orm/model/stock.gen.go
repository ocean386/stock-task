...
type Stock struct {
	...
	TotalMarketValue       float64   `gorm:"column:total_market_value;type:decimal(20,2);not null;default:0.00;comment:总市值" json:"total_market_value"`              // 总市值
	CirculatingMarketValue float64   `gorm:"column:circulating_market_value;type:decimal(20,2);not null;default:0.00;comment:流通市值" json:"circulating_market_value"` // 流通市值
